...
### Member management [#47](https://github.com/superforumio/campfire-ce/pull/47)
...
### Personal invite links [#25](https://github.com/superforumio/campfire-ce/pull/25)
...
### Slack import [#22](https://github.com/superforumio/campfire-ce/pull/22)

Import your Slack workspace into Campfire:
...
### DiceBear avatars [#43](https://github.com/superforumio/campfire-ce/pull/43)
...
### User streaks [#49](https://github.com/superforumio/campfire-ce/pull/49)

Track consecutive days of posting with tiered streak icons displayed next to usernames.


### Theme switch [#15](https://github.com/superforumio/campfire-ce/pull/15)
...
### AnyCable support [#20](https://github.com/superforumio/campfire-ce/pull/20)
...
### Solid Queue [#24](https://github.com/superforumio/campfire-ce/pull/24)
...
### Authentication [#21](https://github.com/superforumio/campfire-ce/pull/21)
...
### Email change Flow [#53](https://github.com/superforumio/campfire-ce/pull/53)
...
### CSS mask-based icons [#45](https://github.com/superforumio/campfire-ce/pull/45)

Replaced image_tag calls with icon_tag helper using CSS masks for automatic color inheritance across light/dark themes.


### Bookmark indicator [#42](https://github.com/superforumio/campfire-ce/pull/42)

Display a small bookmark icon next to message timestamp when bookmarked, with real-time updates.


### AutoBootstrap for headless deployment [#16](https://github.com/superforumio/campfire-ce/pull/16)

Support headless deployment using `AUTO_BOOTSTRAP`, `ADMIN_AUTH_TOKEN`, `ADMIN_EMAIL` environment variables for automated setup.

This is a feature specific for campfirecloud.com


## Fixes

### Soft deletion [#52](https://github.com/superforumio/campfire-ce/pull/52)
...
### Performance [#50](https://github.com/superforumio/campfire-ce/pull/50), [#13](https://github.com/superforumio/campfire-ce/pull/13)
...
The following features from the original Campfire have been removed:

- **Gumroad integration** [#51](https://github.com/superforumio/campfire-ce/pull/51): Removed payment/licensing features
- **Marketing pages** [#44](https://github.com/superforumio/campfire-ce/pull/44): Unauthenticated users redirect directly to sign-in
