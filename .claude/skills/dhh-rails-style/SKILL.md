...
description: Write Ruby and Rails code in DHH's 37signals style. Use when writing Ruby code, Rails controllers, models, views, or any Ruby file. Embodies REST purity, fat models, thin controllers, Current attributes, Hotwire patterns, and "clarity over cleverness".
---

<objective>
Apply 37signals/DHH Rails conventions to Ruby and Rails code. Domain expertise extracted from analyzing production 37signals codebases (Fizzy/Campfire) and DHH's code review patterns.
</objective>
...
|----------|-------------------|
| 1, controller | Read `${CLAUDE_SKILL_DIR}/references/controllers.md` |
| 2, model | Read `${CLAUDE_SKILL_DIR}/references/models.md` |
| 3, view, frontend, turbo, stimulus, css | Read `${CLAUDE_SKILL_DIR}/references/frontend.md` |
| 4, architecture, routing, auth, job, cache | Read `${CLAUDE_SKILL_DIR}/references/architecture.md` |
| 5, test, testing, minitest, fixture | Read `${CLAUDE_SKILL_DIR}/references/testing.md` |
| 6, gem, dependency, library | Read `${CLAUDE_SKILL_DIR}/references/gems.md` |
...
| File | Topics |
|------|--------|
| `${CLAUDE_SKILL_DIR}/references/controllers.md` | REST mapping, concerns, Turbo responses, API patterns, HTTP caching |
| `${CLAUDE_SKILL_DIR}/references/models.md` | Concerns, state records, callbacks, scopes, POROs, authorization, broadcasting |
| `${CLAUDE_SKILL_DIR}/references/frontend.md` | Turbo Streams, Stimulus controllers, CSS layers, OKLCH colors, partials |
| `${CLAUDE_SKILL_DIR}/references/architecture.md` | Routing, authentication, jobs, Current attributes, caching, database patterns |
| `${CLAUDE_SKILL_DIR}/references/testing.md` | Minitest, fixtures, unit/integration/system tests, testing patterns |
| `${CLAUDE_SKILL_DIR}/references/gems.md` | What they use vs avoid, decision framework, Gemfile examples |
</reference_index>
