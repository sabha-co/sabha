...
Rails.application.config.after_initialize do
  %w[ action_text_attachables actiontext_opengraph_embeds action_text_content_attachment_render_by_path action_text_allowed_tags active_storage_analyze_job_suppress_broadcasts active_storage_direct_upload_expiry string ].each do |name|
